...
The **[“Publishing a New Edition”](publishing.html)** section explains how to publish a new edition using either the **command-line Git workflow** or the **GitHub web interface**, using the transition from:
...
The **[“Style Notes and Guidelines”](style-notes.html)** section in the project’s guide back-matter establishes the baseline stylistic and structural conventions for this repository.
